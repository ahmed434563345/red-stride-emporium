...
const MenCapsAccessories = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['products', 'Men / Caps & Accessories'],
    queryFn: async () => {
  ...
  }, [products, sortBy, priceRange, selectedBrands, selectedColors, inStock]);

  const clearFilters = () => {
    setPriceRange('all'); setSortBy('relevance'); setSelectedBrands([]); setSelectedColors([]); setInStock(false);
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">Men's Caps & Accessories</h1>
        <div className="grid lg:grid-cols-4 gap-6">
            ...
            <Card>
              <CardContent className="p-4 space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  {(priceRange !== 'all' || selectedBrands.length > 0 || selectedColors.length > 0 || inStock) && (
          ...
          <div className="lg:col-span-3">
            ...
            {isLoading ? (
              ...
              <div className="text-center text-muted-foreground">No caps or accessories found.</div>
            ) : (
...
export default MenCapsAccessories;
